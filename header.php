			...
			<div class="header section bg-white small-padding">
				...
				<div class="section-inner">
				        ...
				        <a class="blog-logo" href='<?php echo esc_url( home_url() ); ?>' title='<?php echo esc_attr( get_bloginfo( 'title' ) ); ?> &mdash; <?php echo esc_attr( get_bloginfo( 'description' ) ); ?>' rel='home'>
				        	<img src='<?php echo get_template_directory_uri() . '/images/logo-menu.png' ?>' alt='<?php _e('Trabalho de Conclusão de Curso', 'tcc-site'); ?> - <?php _e(' GAME DESIGN NO PROCESSO DE CONSTRUÇÃO DE JOGOS DIGITAIS PARA O ENSINO DA MATEMÁTICA', 'tcc-site'); ?>'>
				        </a>
				
						<h2 class="blog-title">
							<a href="<?php echo esc_url( home_url() ); ?>" rel="home"><?php _e('Trabalho de Conclusão de Curso', 'tcc-site'); ?></a>
						</h2>
						
						<h4 class="blog-tagline">
							<?php _e(' GAME DESIGN NO PROCESSO DE CONSTRUÇÃO DE JOGOS DIGITAIS PARA O ENSINO DA MATEMÁTICA', 'tcc-site'); ?>
						</h4>
